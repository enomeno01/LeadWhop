...
FINAL_COLUMN_ORDER = [
    ...
    "NumberOfEmployees", "Annual_Potential_Volume__c",
...
"Annual_Potential_Volume__c": integer. Estimated annual glass packaging units
  (bottles or jars) this company could buy. Round to nearest:
  500000 / 1000000 / 2000000 / 3000000 / 5000000 / 10000000 / 20000000 / 50000000.
  Base this on their product volume and category (e.g. a major distillery
  uses tens of millions of bottles/year; a small winery uses hundreds of
  thousands).
"""
        import json
        ...
        vol_opts  = [500_000, 1_000_000, 2_000_000, 3_000_000, 5_000_000,
        ...
        profile = {
            ...
            "Annual_Potential_Volume__c": nearest(result.get("Annual_Potential_Volume__c", 1_000_000), vol_opts),
        }
    ...
    def export(self, df: pd.DataFrame, event_name: str) -> pd.DataFrame:
        ...
        profile_cols = {
            ...
            "Market_Positioning__c": [], "Annual_Potential_Volume__c": [],
        }
