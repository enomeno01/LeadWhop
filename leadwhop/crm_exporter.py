...
"""
    ...
    def sub_industry(self, ai_note) -> str:
        ...
        if pd.isna(ai_note) or str(ai_note).strip() == "":
            return default
        system = (
            "Bir şirketin ürün açıklamasına bakarak onu aşağıdaki Sub-Industry "
            "değerlerinden EN UYGUN olanına yerleştir:\n\n"
            + "\n".join(SUB_INDUSTRY_VALUES) + "\n\n"
            "NASIL KARAR VERİLİR:\n"
            "- Önce şirketin GIDA veya İÇECEK üreticisi olup olmadığını KENDİ "
            "bilgine göre değerlendir. İnsanların yediği ya da içtiği herhangi "
            "bir ürünü (yiyecek, içecek, alkol, yağ, sos, çeşni, bal, reçel, "
            "konserve, zeytin, turşu, pesto, şarküteri, kuruyemiş, baharat vb.) "
            "üreten her şirket 'Food & Beverage' ailesindendir. Açıklamada tam "
            "olarak o kelime geçmese bile ürünün ne olduğunu anlayıp karar ver.\n"
            "- Bir şirketi ancak ürünleri gerçekten yenmiyor/içilmiyorsa "
            "(cam, kimyasal, kozmetik, sabun, mum vb.) 'Non-Food' say.\n"
            "- Doğru Food & Beverage alt-dalını seç: bira; süt ürünleri; "
            "alkolsüz içecek; damıtılmış içki (distillery/spirits/gin/vodka/"
            "brandy/liqueur); şarap (wine/sparkling/champagne); yağlar "
            "(zeytinyağı, bitkisel/hayvansal yağ); meyve-sebze işleme (reçel, "
            "turşu, zeytin, konserve sebze, domates); et/deniz ürünü işleme "
            "(et, balık, şarküteri, cured meat). Bunların HİÇBİRİNE net "
            "girmeyen diğer tüm gıdalar (sos, pesto, çeşni, atıştırmalık, "
            "unlu mamul, şekerleme, çikolata, bal, kuruyemiş, hazır yemek) -> "
            "'Food & Beverage - Manufacture of other food products'.\n"
            "- Birden fazla ürün varsa şirketin ANA/baskın faaliyetine göre seç.\n\n"
            "ÖNEMLİ: 'Non-Food - Other Manufacturing' yalnızca şirket gerçekten "
            "gıda/içecek üretmiyorsa kullanılır; bir gıda üreticisini asla "
            "buraya koyma.\n\n"
